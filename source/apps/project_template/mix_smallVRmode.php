 ...
 <!-- VR mode needle mask  -->
  ...
  <script type="text/javascript">
    ...
    $(function() {
      ...
      baseLayerUrl = 'http://120.126.17.210/project/' + course + '/' + chapter + '/' +'200/1610' +
          '/{z}/{x}/{y}.png'
        var layer = L.tileLayer(baseLayerUrl, {
          noWrap: true,
          minZoom: 7,
          maxZoom: 7,
          attribution: 200 + ' X ' + 1610 + " &micro;m"
        });
        layer.addTo(myMap);
      ...
      function changeFocal(e) {
        ...
        baseLayerUrl = 'http://120.126.17.210/project/' + course + '/' + chapter + '/' +'400/'+ e +
          '/{z}/{x}/{y}.png'
        var layer = L.tileLayer(baseLayerUrl, {
          noWrap: true,
          minZoom: 4,
          maxZoom: 7,
          attribution: 400 + ' X ' + e + " &micro;m"
        });
        layer.addTo(myMap);
