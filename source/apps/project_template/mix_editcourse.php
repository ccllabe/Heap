...
<body>
   ...
   var url1 = 'mix1_updated-file_85.json?nocache=' + (new Date()).getTime(); //yolo辨識結果
   ...
   $(function() {
      ...
      myMap.setView(rc.unproject([8466.5, 8071.5]), 3)
      //"lat":76.68231584094876,"lng":-105.13916015625001
